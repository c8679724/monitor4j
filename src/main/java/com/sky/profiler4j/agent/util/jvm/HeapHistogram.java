...
class HeapHistogram implements Serializable {
	...
	private boolean deltaDisplayed; // deltaDisplayed kept for backward
									// compatibility with all collect servers
	...
	/**
	 * @deprecated deltaDisplayed kept only for backward compatibility with all
	 *             collect servers
	 * @return false
	 */
	@Deprecated
