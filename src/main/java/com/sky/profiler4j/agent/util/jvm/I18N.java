 ...
 * dates et de nombre). La locale pour les rapports vient de la requête et est
 * associée au thread courant.
 * 
 * @author Emeric Vernat
 */
final class I18N {
	// RESOURCE_BUNDLE_BASE_NAME vaut
	// "net.bull.javamelody.resource.translations"
	...
	// (Parameters.getResourcePath("translations") seul ne fonctionne pas si on
	// est dans un jar/war)
	...
	/**
	 * Définit la locale (langue et formats dates et nombres) pour le thread
	 * courant.
	 * 
	 * @param locale
	 *            Locale
	 ...
	 *            message à encoder
	 * @param encodeSpace
	 *            booléen selon que les espaces sont encodés en nbsp
	 *            (insécables)
	 * @return String
	 */
	...
	static DateFormat createDurationFormat() {
		...
		// une durée ne dépend pas de l'horaire été/hiver du fuseau horaire de
		// Paris
