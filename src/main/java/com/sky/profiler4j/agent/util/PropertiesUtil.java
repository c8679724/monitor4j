...
public class PropertiesUtil {
	...
	public static void doMonitorSystemProperties(String propertiesFilePath) {
		...
		try {
			pps.load(PropertiesUtil.class.getResourceAsStream(propertiesFilePath));
		...
		ClassesChoose.setExPatterns(patterns2);
	}
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		Class<?>[] classes = new Class<?>[] { List.class, PropertiesUtil.class };
