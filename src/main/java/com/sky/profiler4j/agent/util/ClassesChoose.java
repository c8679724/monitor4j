...
import com.sky.profiler4j.agent.Transformer;
...
public class ClassesChoose {
	...
	/**
	 * 这个类里面是否有需要转换的方法.匹配class里面的每一个方法是否有符合规则的，只要有一个的话就需要做转换(返回true)
	 * 
	 * @param clazz
	 * @return
	 */
	public static boolean isWantTransformer(byte[] classfileBuffer) {
	...
	public static void setExPatterns(Pattern[] exPatterns) {
		ClassesChoose.exPatterns = exPatterns;
	}
}
